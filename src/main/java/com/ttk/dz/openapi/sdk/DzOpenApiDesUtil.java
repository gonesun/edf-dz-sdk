 ...
 * 加密工具类
 */
public class DzOpenApiDesUtil {
    private static final String DES_ALGORITHM = "DES";
    public static final String secretKey = "rx*HpL$YKSGU^sHy7c6ifXreLtDVBj%B";
    /**
     * DES加密
     *
    ...
    public static void main(String[] args) {
        try {
            String before = "111111";
            String after = DzOpenApiDesUtil.encryption(before);
            System.out.println(before+" 加密后为 "+after);
            String before_ = DzOpenApiDesUtil.decryption(after);
            System.out.println(after+" 解密后为 "+before_);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
